...
class Profile(models.Model):
    ...
    COL=(('K.C College of Engineering','K.C College of Engineering'),('K.B College','K.B College')) #change college names
    ...
    CB=(('ComputerScience',"ComputerScience"),('InformationScience',"InformationScience"),('Electronics and Communication',"Electronics and Communication"))
...
class Complaint(models.Model):
    ...
    TYPE=(('Academic Grievance',"Academic Grievance"),('Infrastructure related Complaint',"Infrastructure related Complaint"),('Unfair Treatment',"Unfair Treatment"),('Financial Complaint',"Financial Complaint"),('Other','Other'))
