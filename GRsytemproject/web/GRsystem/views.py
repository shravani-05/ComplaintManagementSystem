...
def pdf_viewer(request):
    ...
    print (delta.days )       
    if detailtype=='1':
            detailtype="Type of Complaint: Academic Grievance"
    if detailtype=='3':
            detailtype="Type of Complaint: Infrastructure related complaint"
    if detailtype=='2':
            detailtype="Type of Complaint: Unfair Treatment"
    if detailtype=='4':
            detailtype="Type of Complaint: Financial Complaint"
    if detailtype=='5':
